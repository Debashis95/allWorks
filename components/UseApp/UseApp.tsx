...
interface useAppProps extends BoxProps {
  howtouseapp: LandingpageData;
}

const UseApp = ({ howtouseapp, ...props }: useAppProps) => {
  return (
    <UseAppWrapper {...props}>
        ...
        <Box className="app_title">
          <Typography variant="h2">
            <Typography variant="caption" className="red_span">
              {howtouseapp?.how_to_use_hdr.slice(0, 10)}
            </Typography>
            {howtouseapp?.how_to_use_hdr.slice(10)}
          </Typography>
          <Typography>{howtouseapp?.how_to_use_sub_hdr}</Typography>
        </Box>
        <Stack direction="row" flexWrap="wrap" className="app_content">
          <List disablePadding className="small_block">
            <ListItem disablePadding>
              ...
              <Typography variant="h4">
                {howtouseapp?.how_to_use_content_hdr_1}
              </Typography>
              <Typography>{howtouseapp?.how_to_use_content_text_1}</Typography>
            </ListItem>
            <ListItem disablePadding>
              <Typography variant="caption" className="poly_gon">
                <LinkIcon />
              ...
              <Typography variant="h4">
                {howtouseapp?.how_to_use_content_hdr_2}
              </Typography>
              <Typography>{howtouseapp?.how_to_use_content_text_2}</Typography>
            </ListItem>
          </List>
          ...
          <List disablePadding className="small_block">
            <ListItem disablePadding>
              ...
              <Typography variant="h4">
                {howtouseapp?.how_to_use_content_hdr_3}
              </Typography>
              <Typography>{howtouseapp?.how_to_use_content_text_3}</Typography>
            </ListItem>
            <ListItem disablePadding>
              <Typography variant="caption" className="poly_gon">
                <VerifiedIcon />
              ...
              <Typography variant="h4">
                {howtouseapp?.how_to_use_content_hdr_4}
              </Typography>
              <Typography>{howtouseapp?.how_to_use_content_text_4}</Typography>
            </ListItem>
          </List>
        </Stack>
      </Container>
